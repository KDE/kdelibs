...
//     static KJob* install(const QString &archivePath, const QString &packageRoot, const QString &servicePrefix);
//     static KJob* uninstall(const QString &packageName, const QString &packageRoot, const QString &servicePrefix);
