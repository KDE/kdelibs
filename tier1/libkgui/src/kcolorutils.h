...
namespace KColorUtils {
     ...
     */
    KGUI_EXPORT qreal luma(const QColor&);
     ...
     */
    KGUI_EXPORT qreal contrastRatio(const QColor&, const QColor&);
     ...
     */
    KGUI_EXPORT QColor lighten(const QColor&, qreal amount = 0.5, qreal chromaInverseGain = 1.0);
     ...
     * @see KColorUtils::shade
     */
    KGUI_EXPORT QColor darken(const QColor&, qreal amount = 0.5, qreal chromaGain = 1.0);
     ...
     * @see KColorUtils::luma
     */
    KGUI_EXPORT QColor shade(const QColor&, qreal lumaAmount, qreal chromaAmount = 0.0);
     ...
     * 1.0 gives @p color
     */
    KGUI_EXPORT QColor tint(const QColor &base, const QColor &color, qreal amount = 0.3);
     ...
     * and @p c2.
     */
    KGUI_EXPORT QColor mix(const QColor &c1, const QColor &c2,
                            qreal bias = 0.5);
     ...
     */
    KGUI_EXPORT QColor overlayColors(const QColor &base, const QColor &paint,
