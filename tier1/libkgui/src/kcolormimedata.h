...
namespace KColorMimeData
{
     ...
     */
    KGUI_EXPORT void populateMimeData(QMimeData *mimeData, const QColor& color);
     ...
     */
    KGUI_EXPORT bool canDecode(const QMimeData *mimeData);
     ...
     */
    KGUI_EXPORT QColor fromMimeData(const QMimeData *mimeData);
     ...
     */
    KGUI_EXPORT QDrag* createDrag(const QColor& color, QWidget *dragsource);
}
