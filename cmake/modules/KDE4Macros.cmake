...
macro (KDE4_ADD_KDEINIT_EXECUTABLE _target_NAME )
   ...
   if(WIN32)
      ...
      configure_file(${KDE4_MODULE_DIR}/../KInit/kde5init_win32lib_dummy.cpp.in ${CMAKE_CURRENT_BINARY_DIR}/${_target_NAME}_win32lib_dummy.cpp)
...
if (_kdeBootStrapping)
  ...
  include("${CMAKE_SOURCE_DIR}/staging/kde4support/src/KDECoreMacros.cmake")
  ...
  include("${KDE4_LIB_DIR}/cmake/KDE4Support/KDECoreMacros.cmake")
  include("${KDE4_LIB_DIR}/cmake/KDE4Support/KDEUIMacros.cmake")
  include("${KDE4_LIB_DIR}/cmake/KDocTools/KDocToolsMacros.cmake")
endif()
