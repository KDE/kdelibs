...
#include "services/resourceidservicepublisherdbusinterface.h"
...
Nepomuk::Backbone::DBus::RegistryBackend::RegistryBackend( QObject* parent )
    : QObject( parent )
{
    ...
    registerServiceType( "http://nepomuk.semanticdesktop.org/services/resource/Identification",
                         new ServicePublisherTypeInterfaceFactory<Services::DBus::ResourceIdServicePublisherInterface>() );
...
Nepomuk::Backbone::DBus::RegistryBackend::~RegistryBackend()
{
}


int Nepomuk::Backbone::DBus::RegistryBackend::registerService( Nepomuk::Backbone::ServicePublisher* service )
{
    ...
    if( !factory ) {
        kDebug(300001) << "(Nepomuk::Backbone::Registry) No service type found for " << service->type() << endl;
    ...
    if( !QDBusConnection::sessionBus().registerService( DBus::dbusServiceFromUrl(service->url()) ) ) {
        kDebug(300001) << "(Nepomuk::Backbone::Registry) failed to register service name " << DBus::dbusServiceFromUrl(service->url()) << endl;
        // FIXME: proper return values
        return -1;
    }
    ...
    if( !QDBusConnection::sessionBus().registerObject( DBus::dbusObjectFromType(service->type()), service ) ) {
        ...
        kDebug(300001) << "(Nepomuk::Backbone::Registry) failed to register object " << DBus::dbusObjectFromType(service->type()) << endl;
        // FIXME: proper return values
        return -1;
    }
...
//     kDebug(300001) << "(Nepomuk::Backbone::Registry) failed to register object " << "/org/semanticdesktop/nepomuk/Service" << endl;
//     // FIXME: proper return values
//     return -1;
//   }
    ...
    if( m_interface->registerService( service->desc() ) != 0 ) {
        ...
        kDebug(300001) << "(Nepomuk::Backbone::Registry) failed to register service with registry " << endl;
        // FIXME: proper return values
        return -1;
    }
...
int Nepomuk::Backbone::DBus::RegistryBackend::unregisterService( Nepomuk::Backbone::ServicePublisher* service )
{
    //
...
Nepomuk::Backbone::ServiceDesc Nepomuk::Backbone::DBus::RegistryBackend::discoverServiceByUrl( const QString& url )
{
    return m_interface->discoverServiceByUrl( url );
}


Nepomuk::Backbone::ServiceDesc Nepomuk::Backbone::DBus::RegistryBackend::discoverServiceByType( const QString& type )
{
    return m_interface->discoverServiceByType( type );
}


QList<Nepomuk::Backbone::ServiceDesc> Nepomuk::Backbone::DBus::RegistryBackend::discoverServicesByName( const QString& name )
{
    return m_interface->discoverServicesByName( name );
}


QList<Nepomuk::Backbone::ServiceDesc> Nepomuk::Backbone::DBus::RegistryBackend::discoverServicesByType( const QString& type )
{
    return m_interface->discoverServicesByType( type );
}


QList<Nepomuk::Backbone::ServiceDesc> Nepomuk::Backbone::DBus::RegistryBackend::discoverAllServices()
{
