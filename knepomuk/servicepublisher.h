...
namespace Nepomuk {
	 ...
	 * \sa \ref knepservice
	 */
	class KNEPOMUK_EXPORT ServicePublisher : public QObject
	    {
		Q_OBJECT
...
/**
 * \relates Nepomuk::Backbone::ServicePublisher
 * The NEPOMUK_KDE_SERVICE_MAIN macro can be used to create a very simple 
 * application around a Nepomuk::Backbone::ServicePublisher implementation.
 *
 * \b Usage:
 * \code
