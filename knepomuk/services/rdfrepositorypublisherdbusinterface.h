...
#ifndef _NEPMUK_BACKBONE_SERVICES_RDFREPOSITORY_DBUS_INTERFACE_H_
#define _NEPMUK_BACKBONE_SERVICES_RDFREPOSITORY_DBUS_INTERFACE_H_
...
namespace Nepomuk {
	...
	namespace DBus {
		...
		public:
		    RDFRepositoryPublisherInterface( Backbone::ServicePublisher* );
