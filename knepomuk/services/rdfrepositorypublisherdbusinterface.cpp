...
Nepomuk::Services::DBus::RDFRepositoryPublisherInterface::RDFRepositoryPublisherInterface( Nepomuk::Backbone::ServicePublisher* p )
    : Backbone::DBus::ServicePublisherInterface( p )
{
}
