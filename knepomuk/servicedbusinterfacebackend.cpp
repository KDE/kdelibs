...
Nepomuk::Backbone::DBus::ServiceBackend::ServiceBackend( const QString& url,
							 const QString& type,
							 QObject* parent )
...
Nepomuk::Backbone::DBus::ServiceBackend::~ServiceBackend()
{
}


bool Nepomuk::Backbone::DBus::ServiceBackend::isAvailable() const
{
