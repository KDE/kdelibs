...
// - RV: KLineEdit "plays with its colors" - related to K4Style?
// - RV: KMulitTabBarTab ... does it need support from K4Style (instead of manual button rotation etc.)? Or is it dumped already?
...
// - LM: User interface guidelines... related to K4Style?
// - e.g. drawFancyPE() in kdeui for KDE widgets: check "qobject_cast<K4Style*>(style())", or fallback drawing...
...
class KDE4SUPPORT_EXPORT K4Style: public QCommonStyle
{
    Q_OBJECT
...
public:
     ...
     * This is just convenience and does /not/ require the using widgets style to inherit K4Style
...
//@{
    ...
    */
    class KDE4SUPPORT_EXPORT ColorMode //krazy:exclude=dpointer (lightweight helper)
    {
    public:
        /**
    ...
    */
    struct KDE4SUPPORT_EXPORT Option
    {
    ...
    struct KDE4SUPPORT_EXPORT OptionBase: public BaseType
    {
    ...
    */
    struct KDE4SUPPORT_EXPORT ColorOption: public OptionBase<ColorOption, Option>
    {
    ...
    */
    struct KDE4SUPPORT_EXPORT IconOption: public OptionBase<IconOption, Option>
    {
     ...
     */
    struct KDE4SUPPORT_EXPORT DoubleButtonOption: public OptionBase<DoubleButtonOption, Option>
    {
        /**
	...
	*/
     ...
     * @sa Window
     */
    struct KDE4SUPPORT_EXPORT TitleButtonOption: public OptionBase<TitleButtonOption, Option>
    {
...
//         bool hover;
    ...
    struct KDE4SUPPORT_EXPORT TextOption: public OptionBase<TextOption, ColorOption>
    {
...
//@{
    ...
    */
    ...
    struct PushButton
    {
         ...
         *
         * [K4Style implements @c QStyle::CE_PushButtonBevel to compose the primitives]
         *
    ...
    struct CheckBox
    {
         ...
         * [K4Style implements QStyle::CE_CheckBox to compose a CheckBox using
    ...
    struct RadioButton
    {
         ...
         * [K4Style implements QStyle::CE_RadioButton to compose a RadioButton using
         *  the mentioned primitives]
         *
         * @sa drawKStylePrimitive()
         */
    ...
    struct DockWidget
    {
         ...
         *
         * [K4Style implements @c QStyle::CE_DockWidgetTitle to split it into K4Style primitives]
         *
         * @sa drawKStylePrimitive()
         */
        enum Primitive
    ...
    struct TabBar
    {
        ...
        enum Primitive
        {
            ...
            IndicatorTear   /**< painted in the left edge of a tabbar when the left
                             ...
                             * @todo K4Style default implementation...? */
        };
    };
...
//@}
    ...
    /**
     * @brief Used to obtain information about K4Style layout properties and metrics.
     *
     ...
     * it yourself.
     *
     * @note This method is not meant to be accessible from outside K4Style.
     *
     ...
     *
     * K4Style implements various elements of QStyle::ComplexControl
     * and QStyle::ControlElement for convenience. Usually complex drawing is
     * split into smaller pieces, which can be text, icons, or other K4Style primitives.
     * These are painted by this method.
     *
     * Common Qt option parameters are unpacked for convenience, and information
     * from K4Style are passed as a KStyleOption.
     *
     * @note This method is not meant to be accessible from outside K4Style.
 ...
 */
template<typename T>
class K4StyleFactory: public QStylePlugin
{
