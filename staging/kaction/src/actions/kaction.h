...
public:
     ...
     */
#ifndef KDE_NO_DEPRECATED
    KACTIONS_DEPRECATED bool globalShortcutAllowed() const;
#endif
     ...
     */
#ifndef KDE_NO_DEPRECATED
    KACTIONS_DEPRECATED void setGlobalShortcutAllowed(bool allowed, GlobalShortcutLoading loading = Autoloading);
#endif
