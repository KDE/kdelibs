...
#ifndef GLOBALSTATIC_P_H
#define GLOBALSTATIC_P_H
...
#ifdef Q_CC_MSVC
# define KWINDOWSYSTEM_GLOBAL_STATIC_STRUCT_NAME(NAME) _solid_##NAME##__LINE__
#else
# define KWINDOWSYSTEM_GLOBAL_STATIC_STRUCT_NAME(NAME)
#endif

#define KWINDOWSYSTEM_GLOBAL_STATIC(TYPE, NAME) KWINDOWSYSTEM_GLOBAL_STATIC_WITH_ARGS(TYPE, NAME, ())

#if (QT_VERSION < QT_VERSION_CHECK(5, 0, 0))

#define KWINDOWSYSTEM_GLOBAL_STATIC_WITH_ARGS(TYPE, NAME, ARGS)                        \
...
static struct KWINDOWSYSTEM_GLOBAL_STATIC_STRUCT_NAME(NAME)                            \
{                                                                              \
    bool isDestroyed()                                                         \
    {                                                                          \
