...
namespace KStdAction
{
  ...
  */
   ...
   */
  KDEUI_EXPORT KAction *openNew( const QObject *recvr, const char *slot,
                                 KActionCollection* parent, const char *name = 0 );

  /**
   * Open an existing file.
   */
  KDEUI_EXPORT KAction *open( const QObject *recvr, const char *slot,
                              KActionCollection* parent, const char *name = 0 );
   ...
   */
  KDEUI_EXPORT KRecentFilesAction *openRecent( const QObject *recvr, const char *slot,
                                               KActionCollection* parent, const char *name = 0 );
   ...
   */
  KDEUI_EXPORT KAction *configureToolbars( const QObject *recvr, const char *slot,
                                           KActionCollection* parent, const char *name = 0 );

  /**
   * The Configure Notifications dialog.
   */
  KDEUI_EXPORT KAction *configureNotifications( const QObject *recvr, const char *slot,
                                                KActionCollection *parent, const char *name = 0);
