...
namespace KColorMimeData
{
     ...
     */
    void KDEUI_EXPORT populateMimeData(QMimeData *mimeData, const QColor& color);
     ...
     */
    bool KDEUI_EXPORT canDecode(const QMimeData *mimeData);
     ...
     */
    QColor KDEUI_EXPORT fromMimeData(const QMimeData *mimeData);
     ...
     */
    QDrag* KDEUI_EXPORT createDrag(const QColor& color, QWidget *dragsource);
};
