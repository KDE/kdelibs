...
int main( int argc, char **argv )
{
  ...
  KSqueezedTextLabel *l1 = new KSqueezedTextLabel( "This is a rather long string", box);
  KSqueezedTextLabel *l2 = new KSqueezedTextLabel( "This is another long string, selectable by mouse", box );
  ...
  layout->addWidget(new QLabel("This is a normal QLabel", box));
