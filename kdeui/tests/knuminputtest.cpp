    ...
    : QWidget(parent, name)
{
    ...
    i7 = new KIntNumInput(b1, i6, 0, 10);
    ...
    d1 = new KDoubleNumInput(b2,0,10,4.0,1,2 /*, "perc_double_no_slider"*/);
    ...
    d2 = new KDoubleNumInput(b2,d1, 0,20,0.422,0.1,3/*, "perc_double_with_slider"*/);
    d2->setLabel("percentage of usage (with slider)", Qt::AlignBottom | Qt::AlignLeft);
    d2->setRange(0, 1.0, 0.005);
    d2->setSuffix("%");
    conn(d2,double);

    d3 = new KDoubleNumInput(b2,d2, 0,20,16.20);
    ...
    d4 = new KDoubleNumInput(b2,d3, 0,INT_MAX,INT_MAX/10000.0,1,1);
    d4->setPrecision(3);
...
//    d4->setFormat("%g");
    ...
    d5 = new KDoubleNumInput(b2,d4, double(INT_MIN+1)/1e9, double(INT_MAX-1)/1e9,
			     0.1, 0.001, 9 /*, "d5"*/);
    d5->setLabel("math test 2: ", Qt::AlignVCenter|Qt::AlignLeft);
    conn(d5,double);

    d6 = new KDoubleNumInput(b2,d5, -10, 10, 0, 0.001, 3 /*, "d6"*/);
    d6->setLabel("aspect ratio test with a negative ratio:");
    d6->setReferencePoint( 1 );

    d7 = new KDoubleNumInput(b2,d6, -30, 30, 0, 0.001, 3 /*, "d7"*/);
