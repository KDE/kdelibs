...
bool KAlphaTest::m_usePixmap=false;
...
int main(int argc, char **argv)
{
  ...
  if (args->isSet("images")) KAlphaTest::m_usePixmap=true;
  else KAlphaTest::m_usePixmap=false; 
  if (args->isSet("dblBuffer")) KAlphaTest::m_useDblBuffer=true;
  else KAlphaTest::m_useDblBuffer=false; 
  if (args->isSet("correctOverlapping")) KAlphaTest::m_correctOverlapping=true;
  else KAlphaTest::m_correctOverlapping=false; 
