  ...
  : QDialog( parent, name, modal )
{
  ...
  QGridLayout *tl_layout = new QGridLayout(this, 3, 2, 10);
  ...
  sysColorCells->setMinimumSize(60, 50);
  ...
  custColorCells->setMinimumSize(60, 50);
  ...
  tl_layout->addLayout(l_right, 0, 1);
  ...
  tl_layout->addMultiCellWidget(sep, 1, 1, 0, 1);
  ...
  tl_layout->addMultiCellWidget(bbox, 2, 2, 0, 1);
