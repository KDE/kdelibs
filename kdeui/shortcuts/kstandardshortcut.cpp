...
//Group TextCompletion
    ...
    { Revert                   , I18N_NOOP2("@action", "Revert")                   , 0, 0, 0, KShortcut(), false },
    { PrintPreview             , I18N_NOOP2("@action", "PrintPreview")             , 0, 0, 0, KShortcut(), false },
    { Mail                     , I18N_NOOP2("@action", "Mail")                     , 0, 0, 0, KShortcut(), false },
    { Clear                    , I18N_NOOP2("@action", "Clear")                    , 0, 0, 0, KShortcut(), false },
    { ActualSize               , I18N_NOOP2("@action", "ActualSize")               , 0, 0, 0, KShortcut(), false },
    { FitToPage                , I18N_NOOP2("@action", "FitToPage")                , 0, 0, 0, KShortcut(), false },
    { FitToWidth               , I18N_NOOP2("@action", "FitToWidth")               , 0, 0, 0, KShortcut(), false },
    { FitToHeight              , I18N_NOOP2("@action", "FitToHeight")              , 0, 0, 0, KShortcut(), false },
    { Zoom                     , I18N_NOOP2("@action", "Zoom")                     , 0, 0, 0, KShortcut(), false },
    { Goto                     , I18N_NOOP2("@action", "Goto")                     , 0, 0, 0, KShortcut(), false },
    { GotoPage                 , I18N_NOOP2("@action", "GotoPage")                 , 0, 0, 0, KShortcut(), false },
    { DocumentBack             , I18N_NOOP2("@action", "DocumentBack")             , 0, 0, 0, KShortcut(), false },
    { DocumentForward          , I18N_NOOP2("@action", "DocumentForward")          , 0, 0, 0, KShortcut(), false },
    { EditBookmarks            , I18N_NOOP2("@action", "EditBookmarks")            , 0, 0, 0, KShortcut(), false },
    { Spelling                 , I18N_NOOP2("@action", "Spelling")                 , 0, 0, 0, KShortcut(), false },
    { ShowToolbar              , I18N_NOOP2("@action", "ShowToolbar")              , 0, 0, 0, KShortcut(), false },
    { ShowStatusbar            , I18N_NOOP2("@action", "ShowStatusbar")            , 0, 0, 0, KShortcut(), false },
    { SaveOptions              , I18N_NOOP2("@action", "SaveOptions")              , 0, 0, 0, KShortcut(), false },
    { KeyBindings              , I18N_NOOP2("@action", "KeyBindings")              , 0, 0, 0, KShortcut(), false },
    { Preferences              , I18N_NOOP2("@action", "Preferences")              , 0, 0, 0, KShortcut(), false },
    { ConfigureToolbars        , I18N_NOOP2("@action", "ConfigureToolbars")        , 0, 0, 0, KShortcut(), false },
    { ConfigureNotifications   , I18N_NOOP2("@action", "ConfigureNotifications")   , 0, 0, 0, KShortcut(), false },
    { TipofDay                 , I18N_NOOP2("@action", "TipofDay")                 , 0, 0, 0, KShortcut(), false },
    { ReportBug                , I18N_NOOP2("@action", "ReportBug")                , 0, 0, 0, KShortcut(), false },
    { SwitchApplicationLanguage, I18N_NOOP2("@action", "SwitchApplicationLanguage"), 0, 0, 0, KShortcut(), false },
    { AboutApp                 , I18N_NOOP2("@action", "AboutApp")                 , 0, 0, 0, KShortcut(), false },
