...
//Group TextCompletion
    ...
    { OpenRecent, "OpenRecent", I18N_NOOP2("@action", ""), 0, 0, KShortcut(), false },
    { SaveAs, "SaveAs", I18N_NOOP2("@action", ""), 0, 0, KShortcut(), false },
    { Revert, "Revert", I18N_NOOP2("@action", ""), 0, 0, KShortcut(), false },
    { PrintPreview, "PrintPreview", I18N_NOOP2("@action", ""), 0, 0, KShortcut(), false },
    { Mail, "Mail", I18N_NOOP2("@action", ""), 0, 0, KShortcut(), false },
    { Clear, "Clear", I18N_NOOP2("@action", ""), 0, 0, KShortcut(), false },
    { ActualSize, "ActualSize", I18N_NOOP2("@action", ""), 0, 0, KShortcut(), false },
    { FitToPage, "FitToPage", I18N_NOOP2("@action", ""), 0, 0, KShortcut(), false },
    { FitToWidth, "FitToWidth", I18N_NOOP2("@action", ""), 0, 0, KShortcut(), false },
    { FitToHeight, "FitToHeight", I18N_NOOP2("@action", ""), 0, 0, KShortcut(), false },
    { Zoom, "Zoom", I18N_NOOP2("@action", ""), 0, 0, KShortcut(), false },
    { Goto, "Goto", I18N_NOOP2("@action", ""), 0, 0, KShortcut(), false },
    { GotoPage, "GotoPage", I18N_NOOP2("@action", ""), 0, 0, KShortcut(), false },
    { DocumentBack, "DocumentBack", I18N_NOOP2("@action", ""), 0, 0, KShortcut(), false },
    { DocumentForward, "DocumentForward", I18N_NOOP2("@action", ""), 0, 0, KShortcut(), false },
    { EditBookmarks, "EditBookmarks", I18N_NOOP2("@action", ""), 0, 0, KShortcut(), false },
    { Spelling, "Spelling", I18N_NOOP2("@action", ""), 0, 0, KShortcut(), false },
    { ShowToolbar, "ShowToolbar", I18N_NOOP2("@action", ""), 0, 0, KShortcut(), false },
    { ShowStatusbar, "ShowStatusbar", I18N_NOOP2("@action", ""), 0, 0, KShortcut(), false },
    { SaveOptions, "SaveOptions", I18N_NOOP2("@action", ""), 0, 0, KShortcut(), false },
    { KeyBindings, "KeyBindings", I18N_NOOP2("@action", ""), 0, 0, KShortcut(), false },
    { Preferences, "Preferences", I18N_NOOP2("@action", ""), 0, 0, KShortcut(), false },
    { ConfigureToolbars, "ConfigureToolbars", I18N_NOOP2("@action", ""), 0, 0, KShortcut(), false },
    { ConfigureNotifications, "ConfigureNotifications", I18N_NOOP2("@action", ""), 0, 0, KShortcut(), false },
    { TipofDay, "TipofDay", I18N_NOOP2("@action", ""), 0, 0, KShortcut(), false },
    { ReportBug, "ReportBug", I18N_NOOP2("@action", ""), 0, 0, KShortcut(), false },
    { SwitchApplicationLanguage, "SwitchApplicationLanguage", I18N_NOOP2("@action", ""), 0, 0, KShortcut(), false },
    { AboutApp, "AboutApp", I18N_NOOP2("@action", ""), 0, 0, KShortcut(), false },
    { AboutKDE, "AboutKDE", I18N_NOOP2("@action", ""), 0, 0, KShortcut(), false },
