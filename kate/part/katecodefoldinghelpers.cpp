...
void KateCodeFoldingTree::updateLine(unsigned int line,
  Q3MemArray<uint> *regionChanges, bool *updated,bool changed,bool colsChanged)
{
...
void KateCodeFoldingTree::addOpening(KateCodeFoldingNode *node,signed char nType, Q3MemArray<uint>* list,unsigned int line,unsigned int charPos)
{
  uint startLine = getStartLine(node);
...
void KateCodeFoldingTree::addOpening_further_iterations(KateCodeFoldingNode *node,signed char /* nType */, Q3MemArray<uint>*
