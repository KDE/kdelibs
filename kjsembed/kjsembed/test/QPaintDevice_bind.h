#ifndef BIND_PaintDevice_H
#define BIND_PaintDevice_H
...
namespace KJSEmbed
{
   class QPaintDeviceBinding : public ObjectBinding
   {
       public:
           QPaintDeviceBinding( KJS::ExecState *exec, QPaintDevice *value );
           static const KJS::ClassInfo info;
           virtual const KJS::ClassInfo* classInfo() const { return &info; }
   };

   class QPaintDeviceData 
   { 
       public: 
