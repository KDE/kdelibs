...
// void invalidate()
START_VARIANT_METHOD( invalidate, QColor )
END_VARIANT_METHOD
}


START_METHOD_LUT( QColor)
{QColor, 0, KJS::DontDelete|KJS::ReadOnly, &QColorNS::QColor },
{QColor, 1, KJS::DontDelete|KJS::ReadOnly, &QColorNS::QColor },
{QColor, 4, KJS::DontDelete|KJS::ReadOnly, &QColorNS::QColor },
{QColor, 1, KJS::DontDelete|KJS::ReadOnly, &QColorNS::QColor },
{QColor, 1, KJS::DontDelete|KJS::ReadOnly, &QColorNS::QColor },
{QColor, 1, KJS::DontDelete|KJS::ReadOnly, &QColorNS::QColor },
{QColor, 1, KJS::DontDelete|KJS::ReadOnly, &QColorNS::QColor },
...
{operator=, 1, KJS::DontDelete|KJS::ReadOnly, &QColorNS::operator= },
{operator=, 1, KJS::DontDelete|KJS::ReadOnly, &QColorNS::operator= },
{operator==, 1, KJS::DontDelete|KJS::ReadOnly, &QColorNS::operator== },
{operator!=, 1, KJS::DontDelete|KJS::ReadOnly, &QColorNS::operator!= },
{operator QVariant, 0, KJS::DontDelete|KJS::ReadOnly, &QColorNS::operator QVariant },
...
{QColor, 4, KJS::DontDelete|KJS::ReadOnly, &QColorNS::QColor },
{invalidate, 0, KJS::DontDelete|KJS::ReadOnly, &QColorNS::invalidate },
END_METHOD_LUT
