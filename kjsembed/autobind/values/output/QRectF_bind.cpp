...
{QRectF, 0, KJS::DontDelete|KJS::ReadOnly, &QRectFNS::QRectF },
{QRectF, 2, KJS::DontDelete|KJS::ReadOnly, &QRectFNS::QRectF },
{QRectF, 4, KJS::DontDelete|KJS::ReadOnly, &QRectFNS::QRectF },
{QRectF, 1, KJS::DontDelete|KJS::ReadOnly, &QRectFNS::QRectF },
...
{operator|, 1, KJS::DontDelete|KJS::ReadOnly, &QRectFNS::operator| },
{operator &, 1, KJS::DontDelete|KJS::ReadOnly, &QRectFNS::operator & },
{operator|=, 1, KJS::DontDelete|KJS::ReadOnly, &QRectFNS::operator|= },
{operator &=, 1, KJS::DontDelete|KJS::ReadOnly, &QRectFNS::operator &= },
