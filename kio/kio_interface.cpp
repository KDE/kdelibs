...
QString KIO::kioErrorString( int _errid, const char *_errortext )
{
  ...
  switch( _errid )
    ...
    case  KIO::ERR_COULD_NOT_MKDIR:
      ...
      break;
    case  KIO::ERR_DOES_ALREADY_EXIST:
...
bool KIOConnectionSignals::testDir( const char *_url )
{
  ...
  m_pConnection->send( KIO::CMD_TESTDIR, static_cast<const char*>(_url), l + 1 );
  return true;
}
...
bool KIOConnectionSignals::get( const char *_url )
{
  ...
  m_pConnection->send( KIO::CMD_GET, static_cast<const char*>(_url), l + 1 );
  return true;
}
...
bool KIOConnectionSignals::getSize( const char *_url )
{
  ...
  m_pConnection->send( KIO::CMD_GET_SIZE, static_cast<const char*>(_url), l + 1 );
  return true;
}
...
bool KIOConnectionSignals::put( const char *_url, int _mode, bool _overwrite, bool _resume, int _size )
{
  ...
  m_pConnection->send( KIO::CMD_PUT, m_pConnection->buffer(), 20 + l + 1 );
  return true;
}
...
bool KIOConnectionSignals::copy( QStringList& _source, const char *_dest )
{
  ...
  m_pConnection->send( KIO::CMD_MCOPY, _dest, l + 1 );
  return true;
}
...
bool KIOConnectionSignals::copy( const char *_source, const char *_dest )
{
  ...
  m_pConnection->send( KIO::CMD_COPY, m_pConnection->buffer(), l1 + 1 + l2 + 1 );
  return true;
}
...
bool KIOConnectionSignals::source( const char *_url )
{
  ...
  m_pConnection->send( KIO::CMD_SOURCE, _url, l + 1 );
  return true;
}
...
bool KIOConnectionSignals::move( QStringList& _source, const char *_dest )
{
  ...
  m_pConnection->send( KIO::CMD_MMOVE, _dest, l + 1 );
...
bool KIOConnectionSignals::move( const char *_source, const char *_dest )
{
  ...
  m_pConnection->send( KIO::CMD_MOVE, m_pConnection->buffer(), l1 + 1 + l2 + 1 );
...
bool KIOConnectionSignals::del( QStringList& _source )
{
  ...
  m_pConnection->send( KIO::CMD_MDEL, "", 0 );
...
bool KIOConnectionSignals::del( const char *_url )
{
  ...
  m_pConnection->send( KIO::CMD_DEL, static_cast<const char*>(_url), l + 1 );
...
bool KIOConnectionSignals::listDir( const char *_url )
{
  ...
  m_pConnection->send( KIO::CMD_LIST, static_cast<const char*>(_url), l + 1 );
  return true;
}
...
bool KIOConnectionSignals::mkdir( const char *_url, int _mode )
{
  ...
  m_pConnection->send( KIO::CMD_MKDIR, m_pConnection->buffer(), 9 + l + 1 );
  return true;
}
...
bool KIOConnectionSignals::data( const void *_buffer, int _len )
{
  ...
  m_pConnection->send( KIO::MSG_DATA, _buffer, _len );
  return true;
}
...
bool KIOConnectionSignals::dataEnd()
{
  ...
  m_pConnection->send( KIO::MSG_DATA_END, 0L, 0 );
  return true;
}
...
bool KIOConnectionSignals::error( int _errid, const char *_text )
{
  ...
  m_pConnection->send( KIO::MSG_ERROR, m_pConnection->buffer(), 5 + l + 1 );
  return true;
}
...
bool KIOConnectionSignals::ready()
{
  ...
  m_pConnection->send( KIO::MSG_READY, 0L, 0 );
  return true;
}
...
bool KIOConnectionSignals::finished()
{
  ...
  m_pConnection->send( KIO::MSG_FINISHED, 0L, 0 );
  return true;
}
...
bool KIOConnectionSignals::renamed( const char *_new )
{
  ...
  m_pConnection->send( KIO::MSG_RENAMED, _new, l + 1 );
  return true;
}
...
bool KIOConnectionSignals::canResume( bool _resume )
{
  ...
  m_pConnection->send( KIO::MSG_RESUME, m_pConnection->buffer(), 1 );
  return true;
}
...
bool KIOConnectionSignals::totalSize( unsigned long _bytes )
{
  ...
  m_pConnection->send( KIO::INF_TOTAL_SIZE, m_pConnection->buffer(), 9 );
  return true;
}
...
bool KIOConnectionSignals::totalFiles( unsigned long _files )
{
  ...
  m_pConnection->send( KIO::INF_TOTAL_COUNT_OF_FILES, m_pConnection->buffer(), 9 );
  return true;
}
...
bool KIOConnectionSignals::totalDirs( unsigned long _dirs )
{
  ...
  m_pConnection->send( KIO::INF_TOTAL_COUNT_OF_DIRS, m_pConnection->buffer(), 9 );
  return true;
}
...
bool KIOConnectionSignals::processedSize( unsigned long _bytes )
{
  ...
  sprintf( m_pConnection->buffer(), "%8x", (int)_bytes );
  m_pConnection->send( KIO::INF_PROCESSED_SIZE, m_pConnection->buffer(), 9 );
  return true;
}
...
bool KIOConnectionSignals::processedFiles( unsigned long _files )
{
  ...
  sprintf( m_pConnection->buffer(), "%8x", (int)_files );
  m_pConnection->send( KIO::INF_PROCESSED_COUNT_OF_FILES, m_pConnection->buffer(), 9 );
  return true;
}
...
bool KIOConnectionSignals::processedDirs( unsigned long _dirs )
{
  ...
  sprintf( m_pConnection->buffer(), "%8x", (int)_dirs );
  m_pConnection->send( KIO::INF_PROCESSED_COUNT_OF_DIRS, m_pConnection->buffer(), 9 );
  return true;
}
...
bool KIOConnectionSignals::scanningDir( const char *_dir )
{
  ...
  m_pConnection->send( KIO::INF_SCANNING_DIR, _dir, l + 1 );
  return true;
}
...
bool KIOConnectionSignals::speed( unsigned long _bytes_per_second )
{
  ...
  m_pConnection->send( KIO::INF_SPEED, m_pConnection->buffer(), 9 );
  return true;
}
...
bool KIOConnectionSignals::copyingFile( const char *_from, const char *_to )
{
  ...
  m_pConnection->send( KIO::INF_COPYING_FILE, m_pConnection->buffer(), l1 + 1 + l2 + 1 );
  return true;
}
...
bool KIOConnectionSignals::makingDir( const char *_dir )
{
  ...
  m_pConnection->send( KIO::INF_MAKING_DIR, _dir, l + 1 );
  return true;
}
...
bool KIOConnectionSignals::gettingFile( const char *_url )
{
  ...
  m_pConnection->send( KIO::INF_GETTING_FILE, static_cast<const char*>(_url), l + 1 );
  return true;
}
...
bool KIOConnectionSignals::deletingFile( const char *_url )
{
  ...
  m_pConnection->send( KIO::INF_DELETING_FILE, static_cast<const char*>(_url), l + 1 );
  return true;
}
...
bool KIOConnectionSignals::redirection( const char *_url )
{
  ...
  m_pConnection->send( KIO::INF_REDIRECTION, static_cast<const char*>(_url), l + 1 );
  return true;
}
...
{
  assert( m_pConnection );
  m_pConnection->send( KIO::INF_ERROR_PAGE, 0L, 0 );
  return true;
}
...
bool KIOConnectionSignals::mimeType( const char *_type )
{
  ...
  m_pConnection->send( KIO::INF_MIME_TYPE, static_cast<const char*>(_type), l + 1 );
  return true;
}
...
bool KIOConnectionSignals::unmount( const char *_point )
{
  ...
  m_pConnection->send( KIO::CMD_UNMOUNT, _point, l + 1 );
  return true;
}
...
bool KIOConnectionSignals::mount( bool _ro, const char *_fstype, const char* _dev, const char *_point )
{
  ...
  m_pConnection->send( KIO::CMD_MOUNT, m_pConnection->buffer(), 1 + l1 + l2 + l3 + 3 );
  return true;
}
...
bool KIOConnectionSignals::listEntry( KUDSEntry& _entry )
{
  ...
  for( ; it != _entry.end(); it++ ) {
    ...
    size += 9;
    if ( (*it).m_uds & KIO::UDS_LONG ) {
      sprintf( p + size, "%8x_", (int)((*it).m_long) );
      size += 9;
    } else if ( (*it).m_uds & KIO::UDS_STRING )  {
  ...
  m_pConnection->send( KIO::MSG_LIST_ENTRY, m_pConnection->buffer(), size + 1 );
  return true;
}
...
bool KIOConnectionSignals::isDirectory()
{
  ...
  m_pConnection->send( KIO::MSG_IS_DIRECTORY, 0L, 0 );
  return true;
}
...
bool KIOConnectionSignals::isFile()
{
  ...
  m_pConnection->send( KIO::MSG_IS_FILE, 0L, 0 );
  return true;
}
...
bool KIOConnectionSlots::dispatch()
{
  ...
  dispatch( (KIO::KIOCommand) cmd, p, len );
  return true;
}

void KIOConnectionSlots::dispatch( KIO::KIOCommand _cmd, void *_p, int _len )
{
  switch( _cmd )
    {
    case KIO::CMD_SOURCE:
	...
	kDebugInfo( 7006 ,"!!!!!!!!! MOUNTING %s %s %s", fstype, dev, point);
    ...
    case KIO::CMD_GET:
      ...
      break;
    case KIO::CMD_GET_SIZE:
      slotGetSize( (const char*)(_p) );
      break;
    case KIO::CMD_TESTDIR:
	...
	slotMkdir( (const char*)(_p) + 9, mode );
      ...
      break;
    case KIO::MSG_IS_DIRECTORY:
      slotIsDirectory();
      break;
    case KIO::MSG_IS_FILE:
      slotIsFile();
      break;
    case KIO::MSG_DATA:
      slotData( _p, _len );
      break;
    case KIO::MSG_DATA_END:
      slotDataEnd();
      break;
    case KIO::MSG_READY:
      slotReady();
      break;
    case KIO::MSG_FINISHED:
      slotFinished();
      break;
    case KIO::MSG_RENAMED:
	...
	for( int i = 0; i < count; i++ )
	{
	  ...
	  else if ( atom.m_uds & KIO::UDS_STRING )
	  {
	    char *p = (char*)_p + size;
	    atom.m_str = p;
	...
	slotCopyingFile( arg1, arg2 );
      ...
      break;
    case KIO::INF_MAKING_DIR:
      slotMakingDir( ( const char*)_p );
      break;
    case KIO::INF_GETTING_FILE:
      slotGettingFile( ( const char*)_p );
      break;
    case KIO::INF_DELETING_FILE:
      slotDeletingFile( ( const char*)_p );
      break;
    case KIO::INF_ERROR_PAGE:
      slotErrorPage();
      break;
    case KIO::INF_REDIRECTION:
      slotRedirection( ( const char*)_p );
      break;
    case KIO::INF_MIME_TYPE:
