...
void KNSBookmarkExporterImpl::write(const KBookmarkGroup &parent)
{
   ...
   fstream << "<!DOCTYPE NETSCAPE-Bookmark-file-1>" << endl
           << QObject::tr("<!-- This file was generated by Konqueror -->") << endl
           << "<META HTTP-EQUIV=\"Content-Type\" CONTENT=\"text/html; charset="
              << charset << "\">" << endl
           << "<TITLE>" << QObject::tr("Bookmarks") << "</TITLE>" << endl
           << "<H1>" << QObject::tr("Bookmarks") << "</H1>" << endl
           << "<DL><p>" << endl
