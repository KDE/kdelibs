...
public:
 ...
 /**
  * This method encodes the given data using the unix
  * uuencode algorithm.
  *
  ...
  *
  * @param  data the data to be uuencoded
  * @return the uuencoded @p data.
  */
  static QByteArray uuencode( const QByteArray& in );

 /**
  * This is a convienence function to uuencode a string.
  *
  * <b>IMPORTANT: This function only works properly for Latin-1
  * characters!</b> It simply puts the data into a QByteArray
  * and invokes @ref base64Encode(const QByteArray&).
  *
  * @param data the data to be uuencoded.
  * @return a uuencoded data.
  */
  static QString uuencode( const QString& in );
  ...
  */
  static QString uudecode( const QString& in );
 ...
 /**
  * A convienence function to encode a QString.
  *
  * <b>IMPORTANT: This function only works properly for Latin-1
  * characters!</b> It simply puts the data into a QByteArray
  * and invokes @ref base64Encode(const QByteArray&).
 ...
 /**
  * A convienence function to decode a QString that is in a
...
public:
   ...
   *
   * IMPORTANT NOTE: <b>This function will only properly work for Latin-1 characters!</b>
   */
