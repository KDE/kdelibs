...
KConfig *cfg;
   ...
   if (!libname.isNull())
         _cryptoLib = ll->library(libname.latin1());
   }
...
// FIXME: #define here for the various OS types to optimize
   ...
   for (QStringList::Iterator it = libpaths.begin();
	 ...
	 if (!access(tmpStr.toLatin1(), R_OK))
            _cryptoLib = ll->library(alib.toLatin1());
         if (_cryptoLib) break;
      }
      if (_cryptoLib) break;
   }
   ...
   if (_cryptoLib) {
#ifdef KSSL_HAVE_SSL
      K_X509_free = (void (*) (X509 *)) _cryptoLib->resolve("X509_free");
      K_RAND_egd = (int (*)(const char *)) _cryptoLib->resolve("RAND_egd");
      K_RAND_load_file = (int (*)(const char *, long)) _cryptoLib->resolve("RAND_load_file");
      K_RAND_file_name = (const char* (*)(char *, size_t)) _cryptoLib->resolve("RAND_file_name");
      K_RAND_write_file = (int (*)(const char *)) _cryptoLib->resolve("RAND_write_file");
      K_CRYPTO_free = (void (*) (void *)) _cryptoLib->resolve("CRYPTO_free");
      K_d2i_X509 = (X509 * (*)(X509 **,unsigned char **,long)) _cryptoLib->resolve("d2i_X509");
      K_i2d_X509 = (int (*)(X509 *,unsigned char **)) _cryptoLib->resolve("i2d_X509");
      K_X509_cmp = (int (*)(X509 *, X509 *)) _cryptoLib->resolve("X509_cmp");
      K_X509_STORE_CTX_new = (X509_STORE_CTX * (*) (void)) _cryptoLib->resolve("X509_STORE_CTX_new");
      K_X509_STORE_CTX_free = (void (*) (X509_STORE_CTX *)) _cryptoLib->resolve("X509_STORE_CTX_free");
      K_X509_verify_cert = (int (*) (X509_STORE_CTX *)) _cryptoLib->resolve("X509_verify_cert");
      K_X509_STORE_new = (X509_STORE * (*) (void)) _cryptoLib->resolve("X509_STORE_new");
      K_X509_STORE_free = (void (*) (X509_STORE *)) _cryptoLib->resolve("X509_STORE_free");
      K_X509_NAME_oneline = (char * (*) (X509_NAME *,char *,int)) _cryptoLib->resolve("X509_NAME_oneline");
      K_X509_get_subject_name = (X509_NAME * (*) (X509 *)) _cryptoLib->resolve("X509_get_subject_name");
      K_X509_get_issuer_name = (X509_NAME * (*) (X509 *)) _cryptoLib->resolve("X509_get_issuer_name");
      K_X509_STORE_add_lookup = (X509_LOOKUP *(*) (X509_STORE *, X509_LOOKUP_METHOD *)) _cryptoLib->resolve("X509_STORE_add_lookup");
      K_X509_LOOKUP_file = (X509_LOOKUP_METHOD *(*)(void)) _cryptoLib->resolve("X509_LOOKUP_file");
      K_X509_LOOKUP_free = (void (*)(X509_LOOKUP *)) _cryptoLib->resolve("X509_LOOKUP_free");
      K_X509_LOOKUP_ctrl = (int (*)(X509_LOOKUP *, int, const char *, long, char **)) _cryptoLib->resolve("X509_LOOKUP_ctrl");
      K_X509_STORE_CTX_init = (void (*)(X509_STORE_CTX *, X509_STORE *, X509 *, STACK_OF(X509) *)) _cryptoLib->resolve("X509_STORE_CTX_init");
      K_X509_dup = (X509* (*)(X509*)) _cryptoLib->resolve("X509_dup");
      K_BIO_s_mem = (BIO_METHOD *(*) (void)) _cryptoLib->resolve("BIO_s_mem");
      K_BIO_new = (BIO* (*)(BIO_METHOD *)) _cryptoLib->resolve("BIO_new");
      K_BIO_new_fp = (BIO* (*)(FILE*, int)) _cryptoLib->resolve("BIO_new_fp");
      K_BIO_new_mem_buf = (BIO* (*)(void *, int)) _cryptoLib->resolve("BIO_new_mem_buf");
      K_BIO_free = (int (*)(BIO*)) _cryptoLib->resolve("BIO_free");
      K_BIO_ctrl = (long (*) (BIO *,int,long,void *)) _cryptoLib->resolve("BIO_ctrl");
      K_BIO_write = (int (*) (BIO *b, const void *data, int len)) _cryptoLib->resolve("BIO_write");
      K_PEM_ASN1_write_bio = (int (*)(int (*)(), const char *,BIO*, char*, const EVP_CIPHER *, unsigned char *, int, pem_password_cb *, void *)) _cryptoLib->resolve("PEM_ASN1_write_bio");
      K_X509_asn1_meth = (ASN1_METHOD* (*)(void)) _cryptoLib->resolve("X509_asn1_meth");
      K_ASN1_i2d_fp = (int (*)(int (*)(), FILE*, unsigned char *)) _cryptoLib->resolve("ASN1_i2d_fp");
      K_i2d_ASN1_HEADER = (int (*)(ASN1_HEADER *, unsigned char **)) _cryptoLib->resolve("i2d_ASN1_HEADER");
      K_X509_print_fp = (int (*)(FILE*, X509*)) _cryptoLib->resolve("X509_print_fp");
      K_i2d_PKCS12 = (int (*)(PKCS12*, unsigned char**)) _cryptoLib->resolve("i2d_PKCS12");
      K_i2d_PKCS12_fp = (int (*)(FILE *, PKCS12*)) _cryptoLib->resolve("i2d_PKCS12_fp");
      K_PKCS12_newpass = (int (*)(PKCS12*, char*, char*)) _cryptoLib->resolve("PKCS12_newpass");
      K_d2i_PKCS12_fp = (PKCS12* (*)(FILE*, PKCS12**)) _cryptoLib->resolve("d2i_PKCS12_fp");
      K_PKCS12_new = (PKCS12* (*)()) _cryptoLib->resolve("PKCS12_new");
      K_PKCS12_free = (void (*)(PKCS12 *)) _cryptoLib->resolve("PKCS12_free");
      K_PKCS12_parse = (int (*)(PKCS12*, const char *, EVP_PKEY**,
                X509**, STACK_OF(X509)**)) _cryptoLib->resolve("PKCS12_parse");
      K_EVP_PKEY_free = (void (*) (EVP_PKEY *)) _cryptoLib->resolve("EVP_PKEY_free");
      K_EVP_PKEY_new = (EVP_PKEY* (*)()) _cryptoLib->resolve("EVP_PKEY_new");
      K_X509_REQ_free = (void (*)(X509_REQ*)) _cryptoLib->resolve("X509_REQ_free");
      K_X509_REQ_new = (X509_REQ* (*)()) _cryptoLib->resolve("X509_REQ_new");
      K_X509_STORE_CTX_set_chain = (void (*)(X509_STORE_CTX *, STACK_OF(X509)*)) _cryptoLib->resolve("X509_STORE_CTX_set_chain");
      K_X509_STORE_CTX_set_purpose = (void (*)(X509_STORE_CTX *, int)) _cryptoLib->resolve("X509_STORE_CTX_set_purpose");
      K_sk_free = (void (*) (STACK *)) _cryptoLib->resolve("sk_free");
      K_sk_num = (int (*) (STACK *)) _cryptoLib->resolve("sk_num");
      K_sk_pop = (char* (*) (STACK *)) _cryptoLib->resolve("sk_pop");
      K_sk_value = (char* (*) (STACK *, int)) _cryptoLib->resolve("sk_value");
      K_sk_new = (STACK* (*) (int (*)())) _cryptoLib->resolve("sk_new");
      K_sk_push = (int (*) (STACK*, char*)) _cryptoLib->resolve("sk_push");
      K_sk_dup = (STACK* (*) (STACK *)) _cryptoLib->resolve("sk_dup");
      K_i2s_ASN1_INTEGER = (char *(*) (X509V3_EXT_METHOD *, ASN1_INTEGER *)) _cryptoLib->resolve("i2s_ASN1_INTEGER");
      K_X509_get_serialNumber = (ASN1_INTEGER * (*) (X509 *)) _cryptoLib->resolve("X509_get_serialNumber");
      K_X509_get_pubkey = (EVP_PKEY *(*)(X509 *)) _cryptoLib->resolve("X509_get_pubkey");
      K_i2d_PublicKey = (int (*)(EVP_PKEY *, unsigned char **)) _cryptoLib->resolve("i2d_PublicKey");
      K_X509_check_private_key = (int (*)(X509 *, EVP_PKEY *)) _cryptoLib->resolve("X509_check_private_key");
      K_BN_bn2hex = (char *(*)(const BIGNUM *)) _cryptoLib->resolve("BN_bn2hex");
      K_X509_digest = (int (*)(const X509 *,const EVP_MD *, unsigned char *, unsigned int *)) _cryptoLib->resolve("X509_digest");
      K_EVP_md5 = (EVP_MD *(*)()) _cryptoLib->resolve("EVP_md5");
      K_ASN1_INTEGER_free = (void (*)(ASN1_INTEGER *)) _cryptoLib->resolve("ASN1_INTEGER_free");
      K_OBJ_obj2nid = (int (*)(ASN1_OBJECT *)) _cryptoLib->resolve("OBJ_obj2nid");
      K_OBJ_nid2ln = (const char *(*)(int)) _cryptoLib->resolve("OBJ_nid2ln");
      K_X509_get_ext_count = (int (*)(X509*)) _cryptoLib->resolve("X509_get_ext_count");
      K_X509_get_ext_by_NID = (int (*)(X509*,int,int)) _cryptoLib->resolve("X509_get_ext_by_NID");
      K_X509_get_ext_by_OBJ = (int (*)(X509*,ASN1_OBJECT*,int)) _cryptoLib->resolve("X509_get_ext_by_OBJ");
      K_X509_get_ext = (X509_EXTENSION* (*)(X509*,int)) _cryptoLib->resolve("X509_get_ext");
      K_X509_delete_ext = (X509_EXTENSION* (*)(X509*,int)) _cryptoLib->resolve("X509_delete_ext");
      K_X509_add_ext = (int (*)(X509*,X509_EXTENSION*,int)) _cryptoLib->resolve("X509_add_ext");
      K_X509_get_ext_d2i = (void* (*)(X509*,int,int*,int*)) _cryptoLib->resolve("X509_get_ext_d2i");
      K_i2s_ASN1_OCTET_STRING = (char *(*)(X509V3_EXT_METHOD*,ASN1_OCTET_STRING*)) _cryptoLib->resolve("i2s_ASN1_OCTET_STRING");
      K_ASN1_BIT_STRING_get_bit = (int (*)(ASN1_BIT_STRING*,int)) _cryptoLib->resolve("ASN1_BIT_STRING_get_bit");
      K_PKCS7_new = (PKCS7 *(*)()) _cryptoLib->resolve("PKCS7_new");
      K_PKCS7_free = (void (*)(PKCS7*)) _cryptoLib->resolve("PKCS7_free");
      K_PKCS7_content_free = (void (*)(PKCS7*)) _cryptoLib->resolve("PKCS7_content_free");
      K_i2d_PKCS7 = (int (*)(PKCS7*, unsigned char**)) _cryptoLib->resolve("i2d_PKCS7");
      K_i2d_PKCS7_fp = (int (*)(FILE*,PKCS7*)) _cryptoLib->resolve("i2d_PKCS7_fp");
      K_i2d_PKCS7_bio = (int (*)(BIO *bp,PKCS7 *p7)) _cryptoLib->resolve("i2d_PKCS7_bio");
      K_d2i_PKCS7 = (PKCS7* (*)(PKCS7**,unsigned char**,long)) _cryptoLib->resolve("d2i_PKCS7");
      K_d2i_PKCS7_fp = (PKCS7 *(*)(FILE *,PKCS7**)) _cryptoLib->resolve("d2i_PKCS7_fp");
      K_d2i_PKCS7_bio = (PKCS7 *(*)(BIO *bp,PKCS7 **p7)) _cryptoLib->resolve("d2i_PKCS7_bio");
      K_PKCS7_dup = (PKCS7* (*)(PKCS7*)) _cryptoLib->resolve("PKCS7_dup");
      K_PKCS7_sign = (PKCS7 *(*)(X509*, EVP_PKEY*, STACK_OF(X509)*, BIO*, int)) _cryptoLib->resolve("PKCS7_sign");
      K_PKCS7_verify = (int (*)(PKCS7*,STACK_OF(X509)*,X509_STORE*,BIO*,BIO*,int)) _cryptoLib->resolve("PKCS7_verify");
      K_PKCS7_get0_signers = (STACK_OF(X509) *(*)(PKCS7 *, STACK_OF(X509) *, int)) _cryptoLib->resolve("PKCS7_get0_signers");
      K_PKCS7_encrypt = (PKCS7* (*)(STACK_OF(X509) *, BIO *, EVP_CIPHER *, int)) _cryptoLib->resolve("PKCS7_encrypt");
      K_PKCS7_decrypt = (int (*)(PKCS7 *, EVP_PKEY *, X509 *, BIO *, int)) _cryptoLib->resolve("PKCS7_decrypt");
      K_PEM_X509_INFO_read = (STACK_OF(X509_INFO) *(*)(FILE*, STACK_OF(X509_INFO)*, pem_password_cb*, void *)) _cryptoLib->resolve("PEM_X509_INFO_read");
      K_ASN1_d2i_fp = (char *(*)(char *(*)(),char *(*)(),FILE*,unsigned char**)) _cryptoLib->resolve("ASN1_d2i_fp");
      K_X509_new = (X509 *(*)()) _cryptoLib->resolve("X509_new");
      K_X509_PURPOSE_get_count = (int (*)()) _cryptoLib->resolve("X509_PURPOSE_get_count");
      K_X509_PURPOSE_get_id = (int (*)(X509_PURPOSE *)) _cryptoLib->resolve("X509_PURPOSE_get_id");
      K_X509_check_purpose = (int (*)(X509*,int,int)) _cryptoLib->resolve("X509_check_purpose");
      K_X509_PURPOSE_get0 = (X509_PURPOSE *(*)(int)) _cryptoLib->resolve("X509_PURPOSE_get0");
      K_EVP_PKEY_assign = (int (*)(EVP_PKEY*, int, char*)) _cryptoLib->resolve("EVP_PKEY_assign");
      K_X509_REQ_set_pubkey = (int (*)(X509_REQ*, EVP_PKEY*)) _cryptoLib->resolve("X509_REQ_set_pubkey");
      K_RSA_generate_key = (RSA* (*)(int, unsigned long, void (*)(int,int,void *), void *)) _cryptoLib->resolve("RSA_generate_key");
      K_i2d_X509_REQ_fp = (int (*)(FILE *, X509_REQ *)) _cryptoLib->resolve("i2d_X509_REQ_fp");
      K_ERR_clear_error = (void (*)()) _cryptoLib->resolve("ERR_clear_error");
      K_ERR_get_error = (unsigned long (*)()) _cryptoLib->resolve("ERR_get_error");
      K_ERR_print_errors_fp = (void (*)(FILE*)) _cryptoLib->resolve("ERR_print_errors_fp");
      K_X509_get1_email = (STACK *(*)(X509 *x)) _cryptoLib->resolve("X509_get1_email");
      K_X509_email_free = (void (*)(STACK *sk)) _cryptoLib->resolve("X509_email_free");
      K_EVP_des_ede3_cbc = (EVP_CIPHER *(*)()) _cryptoLib->resolve("EVP_des_ede3_cbc");
      K_EVP_des_cbc = (EVP_CIPHER *(*)()) _cryptoLib->resolve("EVP_des_cbc");
      K_EVP_rc2_cbc = (EVP_CIPHER *(*)()) _cryptoLib->resolve("EVP_rc2_cbc");
      K_EVP_rc2_64_cbc = (EVP_CIPHER *(*)()) _cryptoLib->resolve("EVP_rc2_64_cbc");
      K_EVP_rc2_40_cbc = (EVP_CIPHER *(*)()) _cryptoLib->resolve("EVP_rc2_40_cbc");
      K_i2d_PrivateKey_fp = (int (*)(FILE*,EVP_PKEY*)) _cryptoLib->resolve("i2d_PrivateKey_fp");
      K_i2d_PKCS8PrivateKey_fp = (int (*)(FILE*, EVP_PKEY*, const EVP_CIPHER*, char*, int, pem_password_cb*, void*)) _cryptoLib->resolve("i2d_PKCS8PrivateKey_fp");
      K_RSA_free = (void (*)(RSA*)) _cryptoLib->resolve("RSA_free");
      K_EVP_bf_cbc = (EVP_CIPHER *(*)()) _cryptoLib->resolve("EVP_bf_cbc");
      K_X509_REQ_sign = (int (*)(X509_REQ*, EVP_PKEY*, const EVP_MD*)) _cryptoLib->resolve("X509_REQ_sign");
      K_X509_NAME_add_entry_by_txt = (int (*)(X509_NAME*, char*, int, unsigned char*, int, int, int)) _cryptoLib->resolve("X509_NAME_add_entry_by_txt");
      K_X509_NAME_new = (X509_NAME *(*)()) _cryptoLib->resolve("X509_NAME_new");
      K_X509_REQ_set_subject_name = (int (*)(X509_REQ*,X509_NAME*)) _cryptoLib->resolve("X509_REQ_set_subject_name");
      K_ASN1_STRING_data = (unsigned char *(*)(ASN1_STRING*)) _cryptoLib->resolve("ASN1_STRING_data");
#endif
   }
   ...
   if (!libname.isNull())
         _sslLib = ll->library(libname.latin1());
   }
#else
   for (QStringList::Iterator it = libpaths.begin();
                              it != libpaths.end();
	 ...
	 tmpStr.replace(QRegExp("\\(.*\\)"), "");
	 if (!access(tmpStr.toLatin1(), R_OK))
         	_sslLib = ll->library(alib.toLatin1());
         if (_sslLib) break;
      }
      if (_sslLib) break;
   }
