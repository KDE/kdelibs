...
public Q_SLOTS:
    ...
    void slotDeleting( KJob*, const KUrl& url );
    void slotTransferring( KJob*, const KUrl& url );
    void slotCreatingDir( KJob*, const KUrl& dir );

public:
    void stating( KJob*, const KUrl& url );
