...
const int defaultSmallFontSizes[MAXFONTSIZES] = { 6, 7, 8, 9, 10, 12, 14, 18, 24, 28, 34, 40, 48, 56, 68 };
const int defaultMediumFontSizes[MAXFONTSIZES] = { 7, 8, 9, 10, 12, 14, 18, 24, 28, 34, 40, 48, 56, 68, 82 };
