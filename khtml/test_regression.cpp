...
int main(int argc, char *argv[])
{
    ...
    if (args->isSet("xvfb"))
    {
        ...
        if ( !xvfb ) {
            char buffer[1000];
            sprintf( buffer, "%s/resources,/usr/X11R6/lib/X11/fonts/75dpi:unscaled,/usr/X11R6/lib/X11/fonts/misc:unscaled,/usr/X11R6/lib/X11/fonts/Type1,/usr/share/fonts/X11/misc", (const char *)baseDir );
