...
public:
    ...
    virtual void paint( QPainter *, int, int, int, int, int, int, RenderObject::PaintPhase) {}
    virtual void paintObject( QPainter *, int, int, int, int, int, int, RenderObject::PaintPhase) {}
