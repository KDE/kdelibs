...
{
#ifdef KJS_VERBOSE
  kdDebug(6070) << "DOMCSSStyleDeclaration::getOwnPropertySlot " << propertyName.qstring() << endl;
#endif
...
{
#ifdef KJS_VERBOSE
  kdDebug(6070) << "DOMStyleSheetList::getOwnPropertySlot " << propertyName.qstring() << endl;
#endif
