...
public:
    QList<Statement> loadOntology( const QUrl& uri )
    {
        ...
        sl.append( Statement( Node( QUrl( ns + "DummyClass" ) ),
                              Node( QUrl( rdfNamespace() + "type" ) ),
                              Node( QUrl( rdfsNamespace() + "Class" ) ) ) );
        sl.append( Statement( Node( QUrl( ns + "DummyClass" ) ),
                              Node( QUrl( rdfsNamespace() + "label" ) ),
        ...
        sl.append( Statement( Node( QUrl( ns + "DummySubClass" ) ),
                              ...
                              Node( QUrl( rdfsNamespace() + "Class" ) ) ) );
        sl.append( Statement( Node( QUrl( ns + "DummySubClass" ) ),
                              Node( QUrl( rdfsNamespace() + "subClassOf" ) ),
        ...
        sl.append( Statement( Node( QUrl( ns + "hasBrother" ) ),
                              Node( QUrl( rdfNamespace() + "type" ) ),
                              Node( QUrl( rdfsNamespace() + "Property" ) ) ) );
        sl.append( Statement( Node( QUrl( ns + "hasBrother" ) ),
                              Node( QUrl( rdfsNamespace() + "domain" ) ),
                              Node( QUrl( ns + "DummyClass" ) ) ) );
        sl.append( Statement( Node( QUrl( ns + "hasBrother" ) ),
                              Node( QUrl( rdfsNamespace() + "range" ) ),
                              Node( QUrl( ns + "DummyClass" ) ) ) );
        sl.append( Statement( Node( QUrl( ns + "hasBrother" ) ),
                              Node( QUrl( nrlNamespace() + "inverseProperty" ) ),
