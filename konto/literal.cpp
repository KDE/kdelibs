...
Konto::Literal::Literal( const Literal& other )
{
    d = other.d;
}
...
Konto::Literal::Literal( const QUrl& dataType )
{
    d = new Private();
...
Konto::Literal& Konto::Literal::operator=( const Literal& other )
{
    d = other.d;
    return *this;
}
...
const QUrl& Konto::Literal::dataTypeUri() const
{
    return d->dataTypeUri;
}


QVariant::Type Konto::Literal::dataType() const
{
    return d->dataType;
}
