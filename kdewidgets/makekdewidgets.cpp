/* Copyright (C) 2004 ian reinhart geiser <geiseri@sourcextreme.com> */
...
static const char classHeader[] = "/* This file was autogenerated by makekdewidgets. Any changes will be lost! */ \n"
...
static const char classDef[] = "#ifndef EMBED_IMAGES\n"
                                ...
                                "#else\n"
                                "		QPixmap pix(locate(\"data\", \"%PluginNameLower/pics/\" + m_widgets[key].iconSet));\n"
                                "#endif\n"
                                "		return QIconSet(pix);\n"
                                "	}\n"
                                "	\n"
                                ...
                                "{\n"
                                "        WidgetInfo widget;\n";
static const char widgetDef[] = "	widget.group = \"%Group\";\n"
                                 "#ifdef EMBED_IMAGES\n"
...
static const char endCtor[] = "	%Init\n"
                               ...
                               "{\n";
static const char widgetCreate[] = "         if (key == \"%Class\")\n"
...
int main( int argc, char **argv ) {
    ...
    KAboutData about( "makekdewidgets", I18N_NOOP( "makekdewidgets" ), version, description, KAboutData::License_GPL, "(C) 2004 ian reinhart geiser", 0, 0, "geiseri@kde.org" );
