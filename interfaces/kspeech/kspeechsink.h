...
class KSpeechSink : virtual public DCOPObject {
    ...
    k_dcop:
        ...
        */
         ...
         * @see markers
         */
        virtual ASYNC markerSeen(const Q3CString&, const QString&) { };
        /**
         ...
         * @see getTextCount
         */
        virtual ASYNC sentenceStarted(const Q3CString&, uint, uint) { };
        /**
         ...
         * @see getTextCount
         */        
        virtual ASYNC sentenceFinished(const Q3CString&, uint, uint) { };
         ...
         * @param jobNum         Job number of the text job.
         */
        virtual ASYNC textSet(const Q3CString&, uint) { };
        ...
        *                       at 1.
        */
        virtual ASYNC textAppended(const Q3CString&, uint, int) { };
         ...
         * @param jobNum         Job number of the text job.
         */
        virtual ASYNC textStarted(const Q3CString&, uint) { };
        /**
         ...
         * @param jobNum         Job number of the text job.
         */
        virtual ASYNC textFinished(const Q3CString&, uint) { };
        /**
         * This signal is emitted whenever a speaking text job stops speaking.
         * @param appId          The DCOP senderId of the application that created the job.  NULL if kttsd.
         * @param jobNum         Job number of the text job.
         */
        virtual ASYNC textStopped(const Q3CString&, uint) { };
        /**
         * This signal is emitted whenever a speaking text job is paused.
         * @param appId          The DCOP senderId of the application that created the job.  NULL if kttsd.
         * @param jobNum         Job number of the text job.
         */
        virtual ASYNC textPaused(const Q3CString&, uint) { };
        /**
         * This signal is emitted when a text job, that was previously paused, resumes speaking.
         * @param appId          The DCOP senderId of the application that created the job.  NULL if kttsd.
         * @param jobNum         Job number of the text job.
         */
        virtual ASYNC textResumed(const Q3CString&, uint) { };
        /**
         ...
         * @param jobNum         Job number of the text job.
         */
        virtual ASYNC textRemoved(const Q3CString&, uint) { };
};
