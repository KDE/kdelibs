    ...
    readonlyGUI(false)
{
  ...
  buttonFirst=new QToolButton(this); 
  CHECK(buttonFirst!=0);
  ...
  buttonSearch=new QToolButton(this);
  ...
  path=(string) KGlobal::iconLoader()->
    iconPath(QString(bgFilename.c_str()), KIconLoader::Medium ).data();
