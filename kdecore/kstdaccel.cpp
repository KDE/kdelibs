...
{
	{ KStdAccel::Open,                I18N_NOOP("Open"), 0,     Qt::CTRL+Qt::Key_O, 0, 0, 0, 0, 0, false },
	{ KStdAccel::New,                 I18N_NOOP("New"), 0,      Qt::CTRL+Qt::Key_N, 0, 0, 0, 0, 0, false },
	{ KStdAccel::Close,               I18N_NOOP("Close"), 0,    Qt::CTRL+Qt::Key_W, Qt::CTRL+Qt::Key_Escape, 0, 0, 0, 0, false },
	{ KStdAccel::Save,                I18N_NOOP("Save"), 0,     Qt::CTRL+Qt::Key_S, 0, 0, 0, 0, 0, false },
	{ KStdAccel::Print,               I18N_NOOP("Print"), 0,    Qt::CTRL+Qt::Key_P, 0, 0, 0, 0, 0, false },
	{ KStdAccel::Quit,                I18N_NOOP("Quit"), 0,     Qt::CTRL+Qt::Key_Q, 0, 0, 0, 0, 0, false },
	{ KStdAccel::Undo,                I18N_NOOP("Undo"), 0,     Qt::CTRL+Qt::Key_Z, 0, 0, 0, 0, 0, false },
	{ KStdAccel::Redo,                I18N_NOOP("Redo"), 0,     Qt::CTRL+Qt::SHIFT+Qt::Key_Z, 0, 0, 0, 0, 0, false },
	{ KStdAccel::Cut,                 I18N_NOOP("Cut"), 0,      Qt::CTRL+Qt::Key_X, 0, Qt::SHIFT+Qt::Key_Delete, 0, 0, 0,false },
	{ KStdAccel::Copy,                I18N_NOOP("Copy"), 0,     Qt::CTRL+Qt::Key_C, 0, Qt::CTRL+Qt::Key_Insert, 0, 0, 0, false },
	{ KStdAccel::Paste,               I18N_NOOP("Paste"), 0,    Qt::CTRL+Qt::Key_V, 0, Qt::SHIFT+Qt::Key_Insert, 0, 0, 0, false },
	{ KStdAccel::SelectAll,           "SelectAll", I18N_NOOP("Select All"), Qt::CTRL+Qt::Key_A, 0,0, 0, 0, 0, false },
	{ KStdAccel::Deselect,            I18N_NOOP("Deselect"), 0, Qt::CTRL+Qt::SHIFT+Qt::Key_A, 0, 0, 0, 0, 0, false },
	{ KStdAccel::DeleteWordBack,      "DeleteWordBack", I18N_NOOP("Delete Word Backwards"), Qt::CTRL+Qt::Key_Backspace, 0, 0, 0, 0, 0, false },
	{ KStdAccel::DeleteWordForward,   "DeleteWordForward", I18N_NOOP("Delete Word Forward"), Qt::CTRL+Qt::Key_Delete, 0,  0, 0, 0, 0, false },
	{ KStdAccel::Find,                I18N_NOOP("Find"), 0,     Qt::CTRL+Qt::Key_F, 0, 0, 0, 0, 0, false },
	{ KStdAccel::FindNext,            "FindNext", I18N_NOOP("Find Next"), Qt::Key_F3, 0, 0, 0, 0, 0, false },
	{ KStdAccel::FindPrev,            "FindPrev", I18N_NOOP("Find Prev"), Qt::SHIFT+Qt::Key_F3, 0, 0, 0, 0, 0, false },
	{ KStdAccel::Replace,             I18N_NOOP("Replace"), 0,  Qt::CTRL+Qt::Key_R, 0, 0, 0, 0, 0, false },
	{ KStdAccel::Home,                I18N_NOOP("Home"), 0,     Qt::CTRL+Qt::Key_Home, 0, 0, 0, 0, 0, false },
	{ KStdAccel::End,                 I18N_NOOP("End"), 0,      Qt::CTRL+Qt::Key_End, 0, 0, 0, 0, 0, false },
	{ KStdAccel::Prior,               I18N_NOOP("Prior"), 0,    Qt::Key_Prior, 0, 0, 0, 0, 0, false },
	{ KStdAccel::Next,                I18N_NOOP("Next"), 0,     Qt::Key_Next, 0, 0, 0, 0, 0, false },
	{ KStdAccel::GotoLine,            "GotoLine", I18N_NOOP("Go to Line"), Qt::CTRL+Qt::Key_G, 0, 0, 0, 0, 0, false },
	{ KStdAccel::AddBookmark,         "AddBookmark", I18N_NOOP("Add Bookmark"), Qt::CTRL+Qt::Key_B, 0, 0, 0, 0, 0, false },
	{ KStdAccel::ZoomIn,              "ZoomIn", I18N_NOOP("Zoom In"), Qt::CTRL+Qt::Key_Plus, 0, 0, 0, 0, 0, false },
	{ KStdAccel::ZoomOut,             "ZoomOut", I18N_NOOP("Zoom Out"), Qt::CTRL+Qt::Key_Minus, 0, 0, 0, 0, 0, false },
	{ KStdAccel::Up,                  I18N_NOOP("Up"), 0,       Qt::ALT+Qt::Key_Up, 0, 0, 0, 0, 0, false },
	{ KStdAccel::Back,                I18N_NOOP("Back"), 0,     Qt::ALT+Qt::Key_Left, 0, 0, 0, 0, 0, false },
	{ KStdAccel::Forward,             I18N_NOOP("Forward"), 0,  Qt::ALT+Qt::Key_Right, 0, 0, 0, 0, 0, false },
	{ KStdAccel::Reload,              I18N_NOOP("Reload"), 0,   Qt::Key_F5, 0, 0, 0, 0, 0, false },
	{ KStdAccel::PopupMenuContext,    "PopupMenuContext", I18N_NOOP("Popup Menu Context"), Qt::Key_Menu, 0, 0, 0, 0, 0, false },
	{ KStdAccel::ShowMenubar,         "ShowMenubar", I18N_NOOP("Show Menu Bar"), Qt::CTRL+Qt::Key_M, 0, 0, 0, 0, 0, false },
	{ KStdAccel::Help,                I18N_NOOP("Help"), 0,     Qt::Key_F1, 0, 0, 0, 0, 0, false },
	{ KStdAccel::WhatThis,            "WhatThis", I18N_NOOP("What's This"), Qt::SHIFT+Qt::Key_F1, 0, 0, 0, 0, 0, false },
	{ KStdAccel::TextCompletion,      "TextCompletion", I18N_NOOP("Text Completion"), Qt::CTRL+Qt::Key_E, 0, 0, 0, 0, 0, false },
	{ KStdAccel::PrevCompletion,      "PrevCompletion", I18N_NOOP("Previous Completion Match"), Qt::CTRL+Qt::Key_Up, 0, 0, 0, 0, 0, false },
	{ KStdAccel::NextCompletion,      "NextCompletion", I18N_NOOP("Next Completion Match"), Qt::CTRL+Qt::Key_Down, 0, 0, 0, 0, 0, false },
	{ KStdAccel::SubstringCompletion, "SubstringCompletion", I18N_NOOP("Substring Completion"), Qt::CTRL+Qt::Key_T, 0, 0, 0, 0, 0, false },
	{ KStdAccel::RotateUp,            "RotateUp", I18N_NOOP("Previous Item in List"), Qt::Key_Up, 0, 0, 0, 0, 0, false },
	{ KStdAccel::RotateDown,          "RotateDown", I18N_NOOP("Next Item in List"), Qt::Key_Down, 0, 0, 0, 0, 0, false }
};
