...
/*****************************************
 * jconv.h
 * Copyright (C) 2002 Arash Bijanzadeh  and FarsiKDE Project <www.farsikde.org>
 * Contact: Arash Bijanzadeh <a.bijanzadeh@linuxiran.org>
 *
 * This program is part of FarsiKDE
 *
 * FarsiKDE is free software; you can redistribute it and/or modify
 ...
 * along with FarsiKDE; if not, write to the Free Software
