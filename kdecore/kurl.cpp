...
// ##############################
// ##############################
//  WARNING: do not make any changes to this file. It will soon be replaced with tests/kurl4.cpp.
//  (this is pending a QUrl bugfix)
// ##############################
// ##############################
// ##############################
// ##############################
...
static QString encode( const QString& segment, int encoding_offset, int encoding_hint )
{
  ...
  if ( !old_length )
    return segment.isNull() ? QString() : QString(""); // differentiate null and empty
