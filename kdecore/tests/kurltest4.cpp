...
void KURLTest::testEmptyQueryOrRef()
{
  ...
  KURL tobi1 = "http://host.net/path/?#http://broken‰adsfk¸poij31¸029muﬂ2890zupyc‹*!*'O¥+ﬂ0i";
...
void KURLTest::testIdn()
{
  ...
  QUrl qurltest( QUrl::fromPercentEncoding( "http://\303\244.de" ) ); // ‰ in utf8
  QVERIFY( qurltest.isValid() );

  //qDebug( "trying QUrl with fromEncoded" );
  QUrl qurl = QUrl::fromEncoded( "http://\303\244.de" ); // ‰ in utf8
