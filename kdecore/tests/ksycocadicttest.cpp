...
#if 0
// Can't do this, KSycocaEntryPrivate isn't exported...
// So we use KMimeType instead.
class KSycocaFakeEntryPrivate : public KSycocaEntryPrivate
{
};

class KSycocaFakeEntry : public KSycocaEntry
{
public:
    KSycocaFakeEntry(const QString& name)
        : KSycocaEntry(*new KSycocaFakeEntryPrivate(name))
    {}
};
#endif
