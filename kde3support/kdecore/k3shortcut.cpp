...
K3Shortcut::K3Shortcut( const KKeySequence& seq )   { init( seq ); }
...
bool K3Shortcut::init( const KKeySequence& seq )
{
	m_nSeqs = 1;
	m_rgseq[0] = seq;
	return true;
...
const KKeySequence& K3Shortcut::seq( uint i ) const
{
...
bool K3Shortcut::contains( const KKeySequence& seq ) const
{
	for( uint i = 0; i < count(); i++ ) {
...
bool K3Shortcut::setSeq( uint iSeq, const KKeySequence& seq )
{
...
void K3Shortcut::remove( const KKeySequence& seq )
{
...
bool K3Shortcut::append( const KKeySequence& seq )
{
