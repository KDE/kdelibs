//----------------------------------------------------------------------------
//    filename             : k3mdichildfrmcaption.h
//----------------------------------------------------------------------------
...
//
//----------------------------------------------------------------------------
#ifndef _K3MDI_CHILD_FRM_CAPTION_H_
#define _K3MDI_CHILD_FRM_CAPTION_H_
...
class K3MdiChildFrmCaptionPrivate;
...
public:
	 ...
	 * Constructor
	 */
	K3MdiChildFrmCaption( K3MdiChildFrm *parent );
...
protected:
	...
	/**
	 * The same as K3MdiChildFrmCaption::slot_moveViaSystemMenu
	 */
	virtual void mousePressEvent( QMouseEvent * );

	/**
	 * Calls maximizePressed of the parent widget ( K3MdiChildFrm )
	 */
	...
	/**
	 * Checks if out of move range of the K3MdiChildArea and calls K3MdiChildFrm::move
	 */
...
private:
	K3MdiChildFrmCaptionPrivate *d;
};

#endif //_K3MDICAPTION_H_
