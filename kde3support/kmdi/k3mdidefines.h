...
//
//----------------------------------------------------------------------------
#ifndef _K3MDI_DEFINES_H_
#define _K3MDI_DEFINES_H_

#include <kdelibs_export.h>

#define K3MDI_CHILDFRM_SEPARATOR 2
#define K3MDI_CHILDFRM_BORDER 4
#define K3MDI_CHILDFRM_DOUBLE_BORDER 8
#define K3MDI_CHILDFRM_MIN_WIDTH 130

//----------------------------------------------------------------------------
/** 
* @short A namespace for the K3MDI library
*/
namespace K3Mdi
{
   /** extent Qt events
      ...
      bool B_MyWidget::event( QEvent* e) {
         if( e->type() == QEvent::Type(QEvent::User + int(K3Mdi::EV_Move))) {
            ...
         }
         ...
      }
   ...
   */
   ...
   /**
   * During K3MdiMainFrm::addWindow the enum AddWindowFlags is used to determine how the view is initialy being added to the MDI system
   */
   enum AddWindowFlags {
      /**
      ...
      * That means it is stay-on-top and toplevel. UseK3MdiSizeHint should use the restore geometry of the
