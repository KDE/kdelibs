...
Q3PopupMenu *K3TextEdit::createPopupMenu( const QPoint &pos )
{
    ...
    if ( isReadOnly() )
      menu->changeItem( menu->idAt(0), KDE::icon("edit-copy"), menu->text( menu->idAt(0) ) );
    else {
      int id = menu->idAt(0);
      menu->changeItem( id - IdUndo, KDE::icon("edit-undo"), menu->text( id - IdUndo) );
      menu->changeItem( id - IdRedo, KDE::icon("edit-redo"), menu->text( id - IdRedo) );
      menu->changeItem( id - IdCut, KDE::icon("edit-cut"), menu->text( id - IdCut) );
      menu->changeItem( id - IdCopy, KDE::icon("edit-copy"), menu->text( id - IdCopy) );
      menu->changeItem( id - IdPaste, KDE::icon("edit-paste"), menu->text( id - IdPaste) );
      menu->changeItem( id - IdClear, KDE::icon("edit-clear"), menu->text( id - IdClear) );

        menu->insertSeparator();
        id = menu->insertItem( KDE::icon( "tools-check-spelling" ), i18n( "Check Spelling..." ),
