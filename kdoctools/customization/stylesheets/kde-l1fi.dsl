<!DOCTYPE style-sheet PUBLIC "-//James Clark//DTD DSSSL Style Sheet//EN" [
 <!ENTITY % fi.words SYSTEM "kde-l1fi.ent">
 %fi.words;
]>
<!--
...
<STYLE-SHEET>
  <STYLE-SPECIFICATION ID="KDE-L10N-FI">
    <STYLE-SPECIFICATION-BODY>

(define %kde-gentext-fi-home-url% "http://www.kde.org/")
(define %kde-gentext-fi-logo-alt% "K Työpöytäympäristö")
(define %kde-gentext-fi-encoding% "iso-8859-1")
(define %kde-gentext-fi-html-header-tags% '())
