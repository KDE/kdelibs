...
Density::Density()
{
    ...
    U(ZettakilogramPerCubicMeter, 1e+21,
    ...
    U(ExakilogramPerCubicMeter, 1e+18,
    ...
    U(PetakilogramPerCubicMeter, 1e+15,
    ...
    U(TerakilogramPerCubicMeter, 1e+12,
    ...
    U(GigakilogramPerCubicMeter, 1e+09,
    ...
    U(MegakilogramPerCubicMeter, 1e+06,
    ...
    U(KilokilogramPerCubicMeter, 1000,
    ...
    U(HectokilogramsPerCubicMeter, 100,
    ...
    U(DecakilogramsPerCubicMeter, 10,
    ...
    U(DecikilogramsPerCubicMeter, 0.1,
    ...
    U(CentikilogramsPerCubicMeter, 0.01,
    ...
    U(MillikilogramsPerCubicMeter, 0.001,
      i18nc("density unit symbol", "mKg/m³"),
    ...
    U(MicrokilogramsPerCubicMeter, 1e-06,
    ...
    U(NanokilogramsPerCubicMeter, 1e-09,
    ...
    U(PicokilogramsPerCubicMeter, 1e-12,
      i18nc("density unit symbol", "pKg/m³"),
    ...
    U(FemtokilogramsPerCubicMeter, 1e-15,
    ...
    U(AttokilogramsPerCubicMeter, 1e-18,
    ...
    U(ZeptokilogramsPerCubicMeter, 1e-21,
      i18nc("density unit symbol", "zKg/m³"),
    ...
    U(YoctokilogramsPerCubicMeter, 1e-24,
      i18nc("density unit symbol", "yKg/m³"),
