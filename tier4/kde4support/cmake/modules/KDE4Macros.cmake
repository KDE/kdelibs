...
macro (KDE4_ADD_KDEINIT_EXECUTABLE _target_NAME )
   ...
   configure_file(${KDE4_MODULE_DIR}/../KF5Init/kde5init_dummy.cpp.in ${CMAKE_CURRENT_BINARY_DIR}/${_target_NAME}_dummy.cpp)
...
if (_kdeBootStrapping)
  ...
  include("${CMAKE_CURRENT_LIST_DIR}/../KF5Auth/KF5AuthMacros.cmake")
  include("${CMAKE_CURRENT_LIST_DIR}/KDECoreMacros.cmake")
  include("${CMAKE_CURRENT_LIST_DIR}/KDEUIMacros.cmake")
  include("${CMAKE_CURRENT_LIST_DIR}/../KF5DocTools/KF5DocToolsMacros.cmake")
  include("${CMAKE_CURRENT_LIST_DIR}/../KF5DesignerPlugin/KF5DesignerPluginMacros.cmake")
endif()
