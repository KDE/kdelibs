...
QPixmap OxygenStyle::standardPixmap ( StandardPixmap standardPixmap, const QStyleOption * option, const QWidget * widget ) const
{
   ...
   case SP_TitleBarMaxButton:
      ...
      painter.setBrush(Gradients::pix(COLOR(Window), rect.height(), Qt::Vertical, Gradients::Sunken));
      painter.drawEllipse(rect);
      painter.setBrush(Gradients::pix(btnBgColor(pal, isEnabled, hover), rndRect.height(), Qt::Vertical, Gradients::Button));
