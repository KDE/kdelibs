<!DOCTYPE style-sheet PUBLIC "-//James Clark//DTD DSSSL Style Sheet//EN" [
 <!ENTITY % ca.words SYSTEM "kde-l1ca.ent">
 %ca.words;
]>
<!--
...
<STYLE-SHEET>
  <STYLE-SPECIFICATION ID="KDE-L10N-CA">
    <STYLE-SPECIFICATION-BODY>

(define %kde-gentext-ca-home-url% "http://linux.softcatala.org/projectes/kde/")
(define %kde-gentext-ca-logo-alt% "The K Desktop Environment")
(define %kde-gentext-ca-encoding% "iso-8859-1") ; 2?
(define %kde-gentext-ca-html-header-tags% '())
(define %kde-gentext-ca-default% "&Default;")
