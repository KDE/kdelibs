<!DOCTYPE style-sheet PUBLIC "-//James Clark//DTD DSSSL Style Sheet//EN" [
 <!ENTITY % da.words SYSTEM "kde-l1da.ent">
 %da.words;
]>
<!--
...
<STYLE-SHEET>
  <STYLE-SPECIFICATION ID="KDE-L10N-DA">
    <STYLE-SPECIFICATION-BODY>

(define %kde-gentext-da-home-url% "http://www.kde.org/")
(define %kde-gentext-da-logo-alt% "The K Desktop Environment")
(define %kde-gentext-da-encoding% "iso-8859-1")
(define %kde-gentext-da-html-header-tags% '())
