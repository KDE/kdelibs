<!DOCTYPE style-sheet PUBLIC "-//James Clark//DTD DSSSL Style Sheet//EN" [
 <!ENTITY % sk.words SYSTEM "kde-l1sk.ent">
 %sk.words;
]>
<!--
...
<STYLE-SHEET>
  <STYLE-SPECIFICATION ID="KDE-L10N-SK">
    <STYLE-SPECIFICATION-BODY>

(define %kde-gentext-sk-home-url% "http://www.kde.org/international/slovakia/")
(define %kde-gentext-sk-logo-alt% "The K Desktop Environment")
(define %kde-gentext-sk-encoding% "iso-8859-2")
(define %kde-gentext-sk-html-header-tags% '())
