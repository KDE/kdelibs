...
const struct HashEntry2 mathTableEntries[] = {
   ...
   { "atan2", Math::ATan2, DontEnum|ReadOnly, &mathTableEntries[32] },
   { "LOG2E", Math::Log2E, DontEnum|ReadOnly, &mathTableEntries[27] },
   { "cos", Math::Cos, DontEnum|ReadOnly, 0 },
   { "max", Math::Max, DontEnum|ReadOnly, &mathTableEntries[29] },
   { 0, 0, 0, 0 },
   { 0, 0, 0, 0 },
   { "LOG10E", Math::Log10E, DontEnum|ReadOnly, &mathTableEntries[24] },
   { "LN2", Math::Ln2, DontEnum|ReadOnly, &mathTableEntries[31] },
   ...
   { "PI", Math::Pi, DontEnum|ReadOnly, &mathTableEntries[28] },
   ...
   { "pow", Math::Pow, DontEnum|ReadOnly, &mathTableEntries[30] },
