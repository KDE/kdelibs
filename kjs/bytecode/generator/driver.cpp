...
static void warnAutogen(QTextStream* out, const char* inName)
{
    *out << "// WARNING: Portions of this file are autogenerated from codes.def and " << inName << ".\n";
