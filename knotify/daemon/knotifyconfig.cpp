...
{
//	kDebug() << k_funcinfo << appname << " , " << eventid << endl;
}
...
//	kDebug() << k_funcinfo << entry << " not found in contexts " << endl;
...
//	kDebug() << k_funcinfo << entry << " not found in config " << endl;
...
//	kDebug() << k_funcinfo << entry << " not found !!! " << endl;
