...
void PGControlDialog::slotDelete()
{
...
void PGControlDialog::slotHostChanged(const QString &newVal)
{
	QListViewItem *itm = m_lst->currentItem();
	if (itm)
...
void PGControlDialog::slotDbChanged(const QString &newVal)
{
	QListViewItem *itm = m_lst->currentItem();
	if (itm)
...
void PGControlDialog::slotItemSelected(QListViewItem *itm)
{
