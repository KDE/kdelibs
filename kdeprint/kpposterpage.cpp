        ...
        : KPrintDialogPage(parent)
{
    ...
    QString whatsThisPostersizePosterPage = i18n(" <qt> "
                                            ...
                                            " <p>Available sizes are all standard paper sizes up to "
    ...
    QString whatsThisPrintsizePosterPage = i18n(" <qt> "
                                           ...
                                           " <p>Available sizes are most standard paper sizes supported by your printer. Your printer's "
                                           ...
                                           " you hit that obstacle, simply use another, supported Paper Size, like 'A4' or 'Letter'.</p> "
    ...
    QString whatsThisCutmarginPosterPage = i18n(" <qt> "
                                           ...
                                           " margins. It indicates to you how much space the cut margins will take away from each tile.</p> "
    ...
    QString whatsThisTileOrderSelectionPosterPage = i18n(" <qt> "
            ...
            " <p>You can fill the field with 2 different methods:</p> "
            " <ul> "
