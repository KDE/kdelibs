...
: KPrintDialogPage(parent,name)
{
	...
	QString whatsThisAddFilterButton = i18n(  " <qt> <b>Add Filter button</b>"
						...
						" subsystem (f.e. CUPS, LPRng, LPD).</p>"
						" </ul>"
						" </qt>" );
	...
	QString whatsThisFilterchainListView = i18n( " <qt> <b>Filtering Chain</b>"
						...
						" <p>The pre-filters act on the prinjob in the order they are listed (from top to bottom). "
						" This is done by acting as a <em>filtering chain</em> where the output of one filter "
						" acts as input to the next. By putting the filters into a correct order, you can make"
						...
						" <p>Please click on the other elements of this dialog to learn mroe about the KDEPrint "
						" pre-filters. "
						" </p>"
						" </qt>" );
