...
public:
    ...
    void setName(const QString& s)  {
        m_name = s; if (m_printername.isEmpty()) m_printername = s;
    }
    const QString& printerName() const {
        return m_printername;
    }
    void setPrinterName(const QString& s) {
        m_printername = s; if (m_name.isEmpty()) m_name = s;
    }
    ...
    // default options
    QString defaultOption(const QString& key) const   {
    ...
    // edited options
    QString editedOption(const QString& key) const   {
