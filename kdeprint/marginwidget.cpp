    ...
    : QWidget(parent), m_default(4, 0), m_pagesize( 2 )
{
	...
	QString whatsThisTopMarginWidget = i18n( " <qt> "
			...
			" <p>The setting works for instance for ASCII text file printing, or for printing from KMail"
			" and Konqueror.. </p>"
			" <p><b>Note:</b></p><p>This margin setting is not intended for KOffice or OpenOffice.org printing, "
	...
	QString whatsThisCheckboxMarginWidget = i18n( " <qt> "
			...
			" <p>Enable this checkbox if you want to modify the margins of your printouts.</p> "
