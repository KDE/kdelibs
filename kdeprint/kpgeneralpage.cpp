...
: KPrintDialogPage(pr,dr,parent,name)
{
	...
	QLabel	*m_papertypelabel = new QLabel(i18n("Paper type:"), this);
	m_papertypelabel->setAlignment(Qt::AlignVCenter|Qt::AlignRight);
	QLabel	*m_inputslotlabel = new QLabel(i18n("Paper source:"), this);
	...
	QRadioButton	*m_revport = new QRadioButton(i18n("Reverse portrait"), m_orientbox);
	...
	QRadioButton	*m_dupshort = new QRadioButton(i18n("Short side"), m_duplexbox);
	...
	QLabel	*m_startbannerlabel = new QLabel(i18n("Start:"), m_bannerbox);
