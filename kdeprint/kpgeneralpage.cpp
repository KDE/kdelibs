        ...
        : KPrintDialogPage(pr, dr, parent)
{
    ...
    QString whatsThisGeneralPaperSourceLabel = i18n(" <qt> "
            ...
            " to be printed on from the drop-down menu.</p>"
            " <p>The exact list of choices depends on the printer driver (\"PPD\") you have installed. </p>"
            " <br />"
            " <hr />"
            " <p><em><b>Additional hint for power users:</b> This KDEPrint GUI element matches"
    ...
    QString whatsThisGeneralOrientationLabel = i18n(" <qt>"
            ...
            " the orientation is <em>Portrait</em></p>"
            " <p>You can select from 4 alternatives:"
            " <ul> "
    ...
    QString whatsThisGeneralDuplexLabel = i18n("<qt>"
                                          ...
                                          " These controls are active if your printer supports duplex printing.</p>"
                                          ...
                                          " side if you fold the paper over the long edge. (Some printer drivers call this mode"
    ...
    QString whatsThisGeneralBannersLabel = i18n(" <qt> "
                                           ...
                                           " <p>Banners may contain some pieces of job information such as user name, time of printing or job"
                                           " title.</p>"
                                           " <p>Banner pages are useful to separate different jobs more easily, especially in a multi-user"
                                           " environment. </p>"
                                           " <p><em><b>Hint:</b></em> You can design your own banner pages. To make use of them, just put the banner"
                                           ...
                                           " GIF. Your added banner pages will appear in the drop down menu CUPS is restarted.</p>"
    ...
    QString whatsThisGeneralPagesPerSheetLabel = i18n("<qt>"
            ...
            " by your printing system. However, some printers are independently capable of printing multiple pages per sheet."
            " In which case you find the option in the printer driver settings. Be careful: if you enable multiple"
