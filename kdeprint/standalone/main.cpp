...
{
	{ "d <printer>",      "Printer/destination to print on",      0},
	{ "t <title>",        "Title for the print job",              0},
	{ "o <option=value>", "Printer option",                       0},
	{ "j <mode>",         "Job output mode (gui, console, none)", "gui"},
	{ "system <printsys>","Print system to use (LPD, CUPS, PDQ)", 0},
	{ "nostdin",          "Forbid impression from STDIN",         0},
...
{
	KCmdLineArgs::init(argc,argv,"kprinter","A printer tool for KDE","0.0.1");
