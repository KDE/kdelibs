...
: KPrintDialogPage(0, driver, parent, name)
{
	...
	QString whatsThisFormatTextPage = i18n( " <qt> "
			...
			" <hr> "
			" <p><b><em>CUPS commandline parameters matching these KDEPrint GUI elements:</em></b></p> "
			" <p>This KDEPrint GUI element matches with the CUPS commandline job option parameter "
			" <pre>"
			"     -o cpi=...         # example: \"8\" or \"12\" "
			" <br> "
	...
	QString whatsThisMarginsTextPage = i18n( " <qt> "
			...
			" <p>Printing from KDE applications like KMail, Konqueror or printing ASCII text file throgh "
			" kprinter lets you choose here your preferred margin settings. </p> "
			...
			" preview picture on the right site). </p> "
			" <hr> "
			" <p><b><em>CUPS commandline parameters matching these KDEPrint GUI elements:</em></b></p> "
			" <p>This KDEPrint GUI element matches with the CUPS commandline job option parameter "
			" <pre>"
