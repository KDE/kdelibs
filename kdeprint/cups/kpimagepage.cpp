    ...
    : KPrintDialogPage(parent)
{
	...
	QString whatsThisHueImagePage = i18n( " <qt>"
			...
			" The following table summarizes the change you will see for the base colors:</p>"
			" <center>"
	...
	QString whatsThisGammaImagePage = i18n( " <qt> "
			...
			" A gamma value greater than 1000 lightens the print. A gamma value less than 1000"
			" darkens the print. The default gamma is 1000. </p>"
			" <p><b>Note:</b></p><p> the gamma value adjustment is not visible in the thumbnail"
			" preview. </p>"
			" <br />"
			" <hr />"
			" <p><em><b>Additional hint for power users:</b> This KDEPrint GUI element matches"
	...
	QString whatsThisSizeImagePage = i18n( " <qt> "
			" <p><b>Image Size:</b> Dropdown menu to control the image size on the printed paper. The menu"
			" works in conjunction with slider below. The options are:</p>"
			" <ul>"
	...
	QString whatsThisPreviewPositionImagePage = i18n( " <qt>"
			...
			" <p>This position preview thumbnail indicates the position of the image on the paper sheet.</p>"
