/*
 * I put all fft stuff in that file, to make it more maintainable.
 * The original distribution is available at the URL.
 *
 * I make also some functions static to minimize collisions
 */
