...
{
	long methodID = _lookupMethodFast("method:0000000e71756572794368696c6472656e00000000082a737472696e6700000000020000000100000007737472696e6700000000056e616d6500");
	long requestID;
	Arts::Buffer *request, *result;
	request = Arts::Dispatcher::the()->createRequest(requestID,_objectID,methodID);
	request->writeString(name);
...
{
	long methodID = _lookupMethodFast("method:000000107175657279496e746572666163657300000000082a737472696e67000000000200000000");
	long requestID;
	Arts::Buffer *request, *result;
	request = Arts::Dispatcher::the()->createRequest(requestID,_objectID,methodID);
	request->patchLength();
...
{
	long methodID = _lookupMethodFast("method:0000000b7175657279547970657300000000082a737472696e67000000000200000000");
	long requestID;
	Arts::Buffer *request, *result;
	request = Arts::Dispatcher::the()->createRequest(requestID,_objectID,methodID);
	request->patchLength();
...
{
	long methodID = _lookupMethodFast("method:0000000b7175657279456e756d7300000000082a737472696e67000000000200000000");
	long requestID;
	Arts::Buffer *request, *result;
	request = Arts::Dispatcher::the()->createRequest(requestID,_objectID,methodID);
	request->patchLength();
...
void Arts::InterfaceRepo_skel::_buildMethodTable()
{
	...
	m.fromString(
        ...
        "00000100000007737472696e6700000000056e616d65000000000e717565727943"
        "68696c6472656e00000000082a737472696e670000000002000000010000000773"
        "7472696e6700000000056e616d6500000000107175657279496e74657266616365"
        "7300000000082a737472696e670000000002000000000000000b71756572795479"
        "70657300000000082a737472696e670000000002000000000000000b7175657279"
        "456e756d7300000000082a737472696e67000000000200000000",
		"MethodTable"
	);
...
static Arts::IDLFileReg IDLFileReg_core("core",
    ...
    "666163655265706f0000000000000000090000000d696e736572744d6f64756c650000"
    ...
    "737472696e6700000000056e616d65000000000e71756572794368696c6472656e0000"
    "0000082a737472696e6700000000020000000100000007737472696e6700000000056e"
    "616d6500000000107175657279496e746572666163657300000000082a737472696e67"
    "0000000002000000000000000b7175657279547970657300000000082a737472696e67"
    "0000000002000000000000000b7175657279456e756d7300000000082a737472696e67"
    "000000000200000000000000000000000000000017417274733a3a466c6f7753797374"
    "656d53656e6465720000000000000000010000000a70726f6365737365640000000005"
    "766f6964000000000100000000000000000000000000000019417274733a3a466c6f77"
    "53797374656d5265636569766572000000000000000000000000010000001172656365"
    "69766548616e646c6572494400000000056c6f6e670000000012000000000000001141"
    "7274733a3a466c6f7753797374656d0000000000000000060000000c73746172744f62"
    "6a6563740000000005766f6964000000000200000001000000076f626a656374000000"
    "00056e6f6465000000000b73746f704f626a6563740000000005766f69640000000002"
    "00000001000000076f626a65637400000000056e6f6465000000000e636f6e6e656374"
    "4f626a6563740000000005766f6964000000000200000004000000076f626a65637400"
    "0000000d736f757263654f626a6563740000000007737472696e67000000000b736f75"
    "726365506f727400000000076f626a656374000000000b646573744f626a6563740000"
    "000007737472696e67000000000964657374506f72740000000011646973636f6e6e65"
